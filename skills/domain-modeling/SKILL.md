...
description: Sharpen domain language; write glossary or ADR decisions. Use for domain terms, glossary, ADRs, or when another skill needs to maintain the domain model.
---
