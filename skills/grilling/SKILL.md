...
If the answer depends on real execution behavior rather than file names or surface structure, trace the relevant entrypoint before recommending an answer.
