...
Turn a PRD, plan, or issue set into a traceable test plan and test case design artifact.
...
- the PRD, source issue, plan, or approved `/to-issues` output
...
- local markdown tracker: write `TEST-PLAN.md` next to the PRD or issue set
- GitHub/GitLab issue tracker: comment on the parent PRD/issue unless project docs specify a child issue
